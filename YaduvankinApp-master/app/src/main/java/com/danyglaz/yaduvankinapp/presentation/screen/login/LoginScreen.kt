...
@Composable
fun LoginView(
    onNavigateTo: (Screen) -> Unit = {},//перейти на новый экран
    ...
    Column(
        ...
        Spacer(modifier = Modifier.height(20.dp))
        Text(text = stringResource(id = R.string.title_login2))
        Spacer(modifier = Modifier.height(20.dp))
            ...
            state.options.forEachIndexed { index, label ->
                SegmentedButton(
                    ...
                    onClick = {
                        ...
                        onEvent(LoginScreenEvent.ButtonEdit(AuthState.LOGIN))
                        //viewModel::updateLoginRegisterButton
